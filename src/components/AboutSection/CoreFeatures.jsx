        ...
        <>
            <section className='max-w-7xl mx-auto py-12'>
                <div className='relative flex-col justify-between space-y-4 text-center my-16 max-w-3xl mx-auto font-serif'>
                    <h3 className=' text-Lightcolor text-2xl font-serif font-semibold '>Core Features</h3>
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
                    <div className="flex flex-wrap justify-evenly gap-6">
                        {steps.map((step) => (
                            <article
                                key={step.id}
                                className="w-64 bg-white hover:bg-primary hover:text-white transition-all duration-200  rounded-lg p-6 shadow-sm hover:shadow-lg transform hover:-translate-y-1  focus:outline-none focus:ring-2 focus:ring-primary text-start border-2"
                                tabIndex={0}
                                aria-labelledby={`step-title-${step.id}`}
                            >
                                <div className="w-12 h-12 rounded-full bg-primary text-white  flex items-center justify-center mb-4 text-xl">
                                    {step.icon}
                                </div>
